...
//p9  middle die
int hard_tam_width[SIZE] = {10, 12, 15, 12, 7};
long int hard_test_time[SIZE] = {605630, 556308, 1835731, 1267313, 94731}; //PSO 2D
// long int hard_test_time[SIZE] = {669329, 651281, 1947063, 1384949, 96297};
